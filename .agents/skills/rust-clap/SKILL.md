---
name: rust-clap
description: 42 rules across 8 categories for building CLI applications in Rust using clap — type-driven design, derive API patterns, argument configuration, validation, subcommand architecture, help/docs, error handling, and testing
---
